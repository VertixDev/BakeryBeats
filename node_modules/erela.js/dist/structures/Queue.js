    ...
    remove(startOrPosition = 0, end) {
        if (typeof end !== "undefined") {
            if (isNaN(Number(startOrPosition))) {
                ...
                throw new RangeError(`Paramenter "start" must be a non-empty number smaller than ${this.length}.`);
            }
        ...
        if (isNaN(Number(startOrPosition))) {
            ...
            throw new RangeError(`Paramenter "position" must be a non-empty number smaller than ${this.length}.`);
        }
